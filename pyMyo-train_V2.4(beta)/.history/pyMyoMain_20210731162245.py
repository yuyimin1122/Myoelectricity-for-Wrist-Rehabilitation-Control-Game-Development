...
class Win(QWidget):
    ...
    def get_emg_data(self):
        ...
        self.emg_pose1 = self.equationcalculate(raw_emg1[0:8,:],200) / self.MVC
        self.emg_pose2 = self.equationcalculate(raw_emg2[0:8,:],200) / self.MVC
        self.emg_pose3 = self.equationcalculate(raw_emg3[0:8,:],200) / self.MVC
        self.emg_pose4 = self.equationcalculate(raw_emg4[0:8,:],200) / self.MVC
