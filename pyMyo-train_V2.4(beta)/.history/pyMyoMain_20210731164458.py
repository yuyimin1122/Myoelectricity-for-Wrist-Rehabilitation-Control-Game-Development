...
class Win(QWidget):
    ...
    def get_emg_data(self):
        ...
        self.emg_max = self.equationcalculate(raw_emg5[0:8,:],200)
        # for i in range(8):
        #     self.MVC[i] = np.mean(self.emg_max[i,:])
        self.MVC = np.max(self.emg_max)
        print(self.MVC)
        self.emg_max = self.emg_max / self.MVC
        self.emg_min = self.equationcalculate(raw_emg6[0:8,:],200) / self.MVC
    ...
    def get_parameter(self,W):
        ...
        pose1_train = self.get_pose_seed(self.emg_pose1)
        pose2_train = self.get_pose_seed(self.emg_pose2)
        pose3_train = self.get_pose_seed(self.emg_pose3)
        pose4_train = self.get_pose_seed(self.emg_pose4)
